setNavBarColors('first-nav-id', 'second-nav-id', 'third-nav-id','fourth-nav-id', 'fifth-nav-id', 'sixth-nav-id');
...
function setNavBarColors(nav_id, non_focused_1, non_focused_2, non_focused_3, non_focused_4, non_focused_5){
...
window.addEventListener("scroll", () => {
    ...
    if(currentScroll >= 340 && currentScroll < 1100){
        setNavBarColors('second-nav-id', 'first-nav-id', 'third-nav-id','fourth-nav-id', 'fifth-nav-id', 'sixth-nav-id')
    }

    if(currentScroll >= 1100 && currentScroll < 2500){
        setNavBarColors('third-nav-id', 'second-nav-id', 'first-nav-id','fourth-nav-id', 'fifth-nav-id', 'sixth-nav-id')
    }
    if(currentScroll >= 2500 && currentScroll < 3400){
        setNavBarColors('fourth-nav-id', 'second-nav-id', 'first-nav-id','third-nav-id', 'fifth-nav-id', 'sixth-nav-id')
    }
    if(currentScroll >= 3400 && currentScroll < 4800){
        setNavBarColors('fifth-nav-id', 'second-nav-id', 'first-nav-id','third-nav-id', 'fourth-nav-id', 'sixth-nav-id')
    }
    if(currentScroll >=4800){
        setNavBarColors('sixth-nav-id', 'second-nav-id', 'first-nav-id','third-nav-id', 'fourth-nav-id', 'fifth-nav-id')
